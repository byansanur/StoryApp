...
import com.byandev.storyapp.presentation.adapter.AdapterStoryPaging
import com.byandev.storyapp.presentation.adapter.FooterStateAdapter
import com.byandev.storyapp.presentation.databinding.FragmentHomeBinding
...
class FragmentHome : BaseFragment<FragmentHomeBinding>(), AdapterStoryPaging.StoryClickListener {
    ...
    override fun initView() {
        ...
        if (sharedPrefManager.isIntroSp) {
            sharedViewModel.navigateToIntro()
        } else {
            if (!sharedPrefManager.isLogin) sharedViewModel.navigateToLogin()
    ...
    private fun callStory() {
        ...
        lifecycleScope.launchWhenCreated {
            ...
            if (utilsConnect.isConnectedToInternet()) {
                presentationViewModel.getListStory(0)
...
//            findNavController().navigate(FragmentHomeDirections.actionFragmentHomeToMapsFragment())
    ...
    override fun storyClicked(story: Stories) {
        sharedViewModel.navigateToDetail(story)
